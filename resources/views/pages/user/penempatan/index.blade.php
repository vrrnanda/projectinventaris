...
<div class="container-fluid">
    <div class="mb-3 mt-2">
        @if($isFiltered)
            <a href="{{ route('') }}" class="btn btn-outline-primary"><i class="bi bi-chevron-left"></i>Kembali</a>
        @endif
    </div>
            ...
            <tr>
                ...
                <td class="text-center">
                    <div class="action-buttons">
                        <a href="/user/konfirmasipenempatan/{{$p->kodepenempatan}}" class="btn btn-outline-primary"><i class="bi bi-check-lg"></i></i></a>
                    </div>
                </td>
            </tr>
            @endforeach
