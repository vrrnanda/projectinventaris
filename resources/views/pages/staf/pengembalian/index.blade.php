...
<div class="container-fluid">
    <div class="mb-3 mt-2">
        @if($isFiltered)
            <a href="{{ route('pengembalianstaf') }}" class="btn btn-outline-primary"><i class="bi bi-chevron-left"></i>Kembali</a>
        @endif
    </div>
    <h1 class="h3 mb-4 text-gray-800 fw-bold">Daftar Pengembalian Barang</h1>
    <form class="form-inline d-flex w-50" method="GET" action="/staf/caripengembalian">
    ...
    <table class="table table-hover mt-2">
        <thead class="thead-light">
            <tr>
                ...
                <th class="text-center" width="70px" scope="col"> Awal Penggunaan</th>
                <th class="text-center" width="70px" scope="col"> Akhir Penggunaan</th>
                <th class="text-center" width="250px" scope="col"> Nama Barang</th>
                <th class="text-center" width="200px" scope="col"> Ruangan</th>
                ...
                <th class="text-center" width="80px" scope="col"> Aksi</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <div class="action-buttons">
                        <a href="/staf/konfirmpengembalian/{{$p->kodepeminjaman}}" class="btn btn-outline-primary"><i class="bi bi-check-lg"></i></i></a>
                    </div>
                </td>
            </tr>
            @endforeach
