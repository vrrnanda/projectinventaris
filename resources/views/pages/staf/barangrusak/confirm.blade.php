...
<div class="container-fluid">
    <div class="col-lg-10 vh-100 p-2">
        ...
        <form action="/staf/updatekonfirmasibarangrusak/{{$barangrusak->kodelaporan}}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col">
                ...
                <label>Tanggal Laporan</label>
                    <input type="text" name="tgllapor" class="form-control" value="{{$barangrusak->tgllaporan}}" readonly>
                </div>
            </div>
            <div class="row">
                <div class="col">
            ...
            <div class="mb-3 mt-2">
                ...
                <select class="form-select " name="penanganan">
                    <option value="" disabled selected hidden>Pilih Penanganan</option>
                    <option value="Perbaikan eksternal">Perbaikan Eksternal</option>
                    <option value="Perbaikan internal">Perbaikan Internal</option>
                </select>
            </div>
