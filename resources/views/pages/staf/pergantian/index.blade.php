...
<div class="container-fluid">
    <div class="mb-3 mt-2">
        @if($isFiltered)
            <a href="{{ route('pergantianstaf') }}" class="btn btn-outline-primary"><i class="bi bi-chevron-left"></i>Kembali</a>
        @endif
    </div>
    <h1 class="h3 mb-4 text-gray-800 fw-bold">Daftar Pergantian Barang</h1>
    <div class="d-flex justify-content-between">
    </div>
    <form class="form-inline d-flex w-50" method="GET" action="/staf/caripergantian">
            ...
            <tr>
                ...
                <td class="text-center">
                    <div class="action-buttons">
                        <a href="/staf/konfirmpergantian/{{$pg->kodepergantian}}" class="btn btn-outline-primary"><i class="bi bi-check-lg"></i></i></a>
                    </div>
                </td>
            </tr>
            @endforeach
