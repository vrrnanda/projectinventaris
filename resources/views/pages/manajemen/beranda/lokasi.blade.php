...
<div class="mb-3 mt-2">
    @if(request('ruangan') || request('bulan'))
        <a href="{{ route('filtermanajemen') }}" class="btn btn-outline-primary"><i class="bi bi-chevron-left"></i>Kembali</a>
    @else
        <a href="{{ route('berandamanajemen') }}" class="btn btn-outline-primary"><i class="bi bi-chevron-left"></i>Kembali</a>
    @endif
</div>
<div class="d-flex justify-content-between">
    <form action="{{ route('filtermanajemen') }}" method="GET" class="me-2">
    ...
    <form action="{{ route('filtermanajemen') }}" method="GET">
