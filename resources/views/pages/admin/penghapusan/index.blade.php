...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-4 text-gray-800 fw-bold">Daftar Penghapusan Barang</h1>
    <div class="d-flex justify-content-between">
        <a href="/admin/tambahenghapusan" class="btn btn-outline-primary mt-2"><i class="bi bi-plus-square-fill"></i> Tambah Data </a>
    </div>
    ...
    <table class="table table-hover mt-2">
        <thead class="thead-light">
            <tr>
                ...
                <th class="text-center" width="50px" scope="col"> Aksi</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="text-left">{{ $bh->namabrg}}</td>
                <td class="text-center">{{ $bh->jumlah}}</td>
                <td class="text-center">{{ $bh->status}}</td>
                <td class="text-center">
                    <div class="action-buttons">
                        <a href="/admin/detailpenghapusan/{{$bh->kodehapus}}" class="btn btn-outline-info"><i class="bi bi-eye"></i></a>
                        <a href="/admin/editpenghapusan/{{$bh->kodehapus}}" class="btn btn-outline-success"><i class="bi bi-pencil-square"></i></a>
                        <a href="/admin/hapuspenghapusan/{{$bh->kodehapus}}" onclick="return confirm('Apakah anda yakin ingin menghapus data?')" class="btn btn-outline-danger"><i class="bi bi-trash3-fill"></i></a>
                    </div>
                </td>
            </tr>
            @endforeach
