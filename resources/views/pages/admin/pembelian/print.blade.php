            ...
            <table class="table table-hover mt-5">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th class="text-center" width="50px" scope="col"> Kode Pembelian</th>
                        <th class="text-center" width="50px" scope="col"> Tanggal Pembelian</th>
                        <th class="text-center" width="100px" scope="col"> Nama Barang</th>
                        <th class="text-center" width="100px" scope="col"> Spesifikasi</th>
                        <th class="text-center" width="30px" scope="col"> Jumlah</th>
                        <th class="text-center" width="50px" scope="col"> Biaya</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $pb->kodepembelian }}</td>
                        <td class="text-center">{{ $pb->tglbeli }}</td>
                        <td class="text-center">{{ $pb->namabrg }}</td>
                        <td class="text-center">{{ $pb->spesifikasi }}</td>
                        <td class="text-center">{{ $pb->jumlah }}</td>
                        <td class="text-center">{{ $pb->harga }}</td>
                        <td class="text-center">{{ $pb->tglterima }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
