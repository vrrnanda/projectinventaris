...
<div class="container-fluid">
    <div class="mb-3 mt-2">
        @if($isFiltered)
            <a href="{{ route('pengembalianadmin') }}" class="btn btn-outline-primary"><i class="bi bi-chevron-left"></i>Kembali</a>
        @endif
    </div>
    <h1 class="h3 mb-4 text-gray-800 fw-bold">Daftar Pengembalian Barang</h1>
    <div class="d-flex justify-content-between mt-2">
        <form action="{{ route('filterpengembalian') }}" method="GET" class="d-flex">
        ...
        <div class="d-flex justify-content-end mt-2">
            <a href="{{ route('printpengembalian', ['bulan' => request('bulan')]) }}" class="btn btn-outline-primary mt-2">
